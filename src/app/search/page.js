// B.I.I.A - Busca Inteligente de Investimentos em Atos
'use client';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex space-x-8">
              <Link href="/search" className="text-blue-600 font-medium text-sm">
                Buscar
              </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Busca de Investimentos</h1>
          <p className="text-xl text-gray-600">Encontre investimentos em tecnologias educacionais nos diários oficiais municipais</p>
        </div>

        {/* Filtros */}
        <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Configurar Busca</h2>
          ...
          <div className="mt-8">
            <button
              ...
              disabled={isLoading}
              className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white px-8 py-3 rounded-lg font-semibold text-lg transition-colors shadow-lg"
            >
              {isLoading ? 'Buscando...' : '🔍 Pesquisar Investimentos'}
            </button>
          </div>
        </div>
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-semibold text-gray-900">
              {gazettes.length} investimento(s) encontrado(s)
            </h2>
            {filters.categoria && (
          ...
          {gazettes.map((gazette, index) => (
            <div key={index} className="border border-gray-200 rounded-lg p-6 mb-6 hover:shadow-lg transition-shadow bg-gray-50">
          ...
          {gazettes.length === 0 && !isLoading && (
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-4">Nenhum investimento em tecnologia educacional foi encontrado nos diários oficiais com os filtros atuais.</p>
